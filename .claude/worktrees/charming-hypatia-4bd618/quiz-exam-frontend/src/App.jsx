...
import ProfessorPapers from './pages/professor/ProfessorPapers'
    ...
    <div className={isAuthenticated ? 'appShell authShell' : 'appShell publicShell'}>
      ...
      <main className={isAuthenticated ? 'appMain appMainAuthed' : 'appMain'}>
        <Routes>
          ...
          <Route path="/professor/papers" element={<ProtectedRoute allowedRoles={['PROFESSOR']}><ProfessorPapers /></ProtectedRoute>} />
