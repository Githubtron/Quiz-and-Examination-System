...
export const users = {
  ...
  listStudents: () => request('GET', '/api/users/students'),
...
// ── Papers ────────────────────────────────────────────────────────────────────
export const papers = {
  batchGenerate: (examId, studentIds) =>
    request('POST', `/api/exams/${examId}/papers/batch-generate`, { studentIds }),
  list: (examId) => request('GET', `/api/exams/${examId}/papers`),
  export: (examId, studentId, label) =>
    request('GET', `/api/exams/${examId}/papers/${studentId}/export?label=${encodeURIComponent(label)}`),
}
